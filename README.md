  ...
  audit:
    ...
    steps:
      ...
      - name: Run Solidity Audit
        uses: waldenwolf/jacques-the-solidity-auditor@main
        with:
...
```bash
git clone https://github.com/waldenwolf/jacques-the-solidity-auditor.git
cd jacques-the-solidity-auditor
npm install
```
